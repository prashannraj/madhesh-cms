...
class SliderResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
                ...
                Forms\Components\TextInput::make('link')->label('Optional Button Link'),
                Forms\Components\Toggle::make('is_active')->label('Visible?'),
            ]);
    }
    ...
    public static function table(Table $table): Table
    {
        return $table->columns([
                ...
                Tables\Columns\TextColumn::make('subtitle')->limit(20),
